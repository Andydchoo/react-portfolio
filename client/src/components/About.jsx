      ...
      <Box>
        ...
        >
          <Container
            sx={{
              ...
              maxWidth: { xs: 'sm', sm: 'sm', med: 'sm', lg: 'lg' },
              alignItems: 'center'
            }}>
            <Typography
              component="h1"
        ...
        >
          <Container
            maxWidth="xl"
            sx={{
              display: { xs: 'none', sm: 'none', med: 'none', lg: 'flex' },
              maxWidth: "xl",
              flexDirection: 'row',
          ...
          >
            ...
            <Stack direction="column" sx={{ display: 'flex', justifyContent: 'center', flex: "1" }}>
              <Typography
                component="h1"
                variant="h2"
                align="center"
          ...
          <Stack
            sx={{ pt: 4, display: { xs: 'none', sm: 'none', med: 'none', lg: 'flex' } }}
            direction="row"
            spacing={3}
            justifyContent="center"
          >
